...
\begin{itemize}[itemsep=1pt, parsep=0pt,leftmargin=*]
  \item[] \textbf{Massachusetts Institute of Technology}, Cambridge, MA
    \begin{itemize}[itemsep=1pt, parsep=0pt,leftmargin=*]
    \item[] \textbf{Elliott Slaughter} (UROP) \hfill (Spring 2026--)
    \item[] \textbf{Joseph Choi} (PhD Student) \hfill (Spring 2026--)
    \item[] \textbf{Jeongdong Kim} (Visiting Scholar; Yonsei University) \hfill (Fall 2025--)
    \item[] \textbf{Yurim Kim} (Visiting Scholar; Yonsei University) \hfill (Fall 2025--)
    ...
    \item[] \textbf{Archim Jhunjhunwala} (HIP-SAT visiting student) \hfill (Summer 2025--Fall 2025)
